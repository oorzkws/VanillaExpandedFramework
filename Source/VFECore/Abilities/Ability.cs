namespace VFECore.Abilities
{
    ...
    public abstract class Ability : IExposable, ILoadReferenceable, ITargetingSource
    {
        ...
        private float CalculateStatOffsetForPawn(float current, StatModifier statOffset) =>
        ...
        private float CalculateModifiedStatForPawn(float current, IEnumerable<StatModifier> statFactors, IEnumerable<StatModifier> statOffsets) =>
